...
class UpdatePatientUseCase:
    ...
    def handle(self, patient_id: UUID, data: UpdatePatientDTO) -> PatientResponseDTO:
        ...
        updated_patient = self.patient_repository.save(patient)
        return self.patient_mapper.to_response(updated_patient)
