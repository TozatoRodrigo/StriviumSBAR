...
def get_refresh_token_service(
    ...
    return RefreshTokenService(repository, strict_mode=envs.REFRESH_TOKEN_STRICT_MODE)
...
def get_default_auth_use_case(
    ...
    return DefaultAuthUseCase(user_service, refresh_token_service)
...
def get_refresh_user_auth_use_case(
    ...
    return RefreshUserAuthUseCase(user_service, refresh_token_service)
...
def get_refresh_tenant_auth_use_case(
    ...
    return RefreshTenantAuthUseCase(
        tenant_service, tenant_auth_use_case, refresh_token_service
    )
